...
if ($addnew=="1" )
{
	...
	mysql_query($sql);
	echo "<script>javascript:alert('Success!');location.href='dx.php?lb=$lb';</script>";
}
?>
...
<body>
<p>Modified<?php echo $lb;?>： Date： <?php echo $ndate; ?></p>
<?php
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      <tr>
        <td>Content：</td>
        <td><textarea name="neirong" style="width:700px;height:200px;visibility:hidden;"><?php echo mysql_result($query,$i,content)?></textarea></td></tr>
    <tr>
      <td>&nbsp;</td>
